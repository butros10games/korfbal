	...
	js.configs.recommended,
	{
		...
		languageOptions: {
			...
			globals: {
				...
				...globals.commonjs,
				django: false,
				initializeSocket: "readonly",
				requestInitalData: "readonly",
				setupCarousel: "readonly",
				setupFollowButton: "readonly",
				cleanDom: "readonly",
				updateMatches: "readonly",
				UpdateStatastics: "readonly",
				truncateMiddle: "readonly",
			},
		},
	},
	{
