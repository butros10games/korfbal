...
SPORTLINK_SYNC_SEASON = ""
SPORTLINK_SYNC_SESSION_FILE = ""
SPORTLINK_SYNC_MAX_REQUESTS = 0
SPORTLINK_SYNC_MAX_SECONDS = 240
SPORTLINK_HOURLY_LIMIT = 0
SPORTLINK_DAILY_LIMIT = 0
SPORTLINK_REQUEST_SPACING = 5
