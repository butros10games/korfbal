...
# Bulk video/model/dataset files are disposable. JSON control metadata is retained.
VIDEO_ANALYSIS_WORKSPACE_MAX_BYTES = int(
    env("VIDEO_ANALYSIS_WORKSPACE_MAX_BYTES", "8000000000")
)
