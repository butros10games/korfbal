...
ENDPOINTS = {
    ...
    "match_facility": ("match/MatchFacility", "PublicMatchId", 3, 87600),
    "match_rules": ("match/MatchInfo", "PublicMatchId", 1, 87600),
    "match_timing": ("match/MatchResultDetails", "PublicMatchId", 8, 87600),
