...
class PlayerGroup(models.Model):
    ...
    starting_type = models.ForeignKey('GroupType', on_delete=models.CASCADE, related_name='player_groups')
    current_type = models.ForeignKey('GroupType', on_delete=models.CASCADE, related_name='current_player_groups')
