...
def test_create_goal_command_commits_one_revision_and_publication() -> None:
...
@pytest.mark.django_db(transaction=True)
def test_substitution_commands_own_the_full_event_lifecycle() -> None:
...
@pytest.mark.django_db(transaction=True)
def test_pause_commands_own_the_full_event_lifecycle() -> None:
